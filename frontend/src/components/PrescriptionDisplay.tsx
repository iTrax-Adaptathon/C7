...
export function PrescriptionDisplay({ prescription, size = 'md', accentClass = 'text-white' }: PrescriptionDisplayProps) {
  ...
  return (
    <div className="flex items-baseline gap-2 font-mono">
      ...
      <span className={`${restSize} font-semibold text-slate-300`}>
